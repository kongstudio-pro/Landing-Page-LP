        ...
        <section className="w-full bg-gradient-to-b from-white to-slate-50 min-h-screen py-12">
            <div className="mx-auto max-w-7xl px-6">
                <header className="flex flex-col items-center text-center mb-12">
                    <Image src="/images/reels/reels01.png" alt="Kelas 1" width={80} height={80} className="mb-4" />
                    <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-4">Kelas 1 SD</h1>
                    <p className="max-w-2xl text-lg text-slate-600">Materi, tugas, dan aktivitas interaktif untuk siswa Kelas 1 SD. Semua fitur Lembar Pintar dirancang untuk pembelajaran kreatif dan digital.</p>
                </header>
                    ...
                    {[1, 4, 7].map((imgIdx, i) => {
                        ...
                        return (
                            <div key={i} className="rounded-2xl bg-white shadow-lg p-6 flex flex-col items-center">
                                ...
                                <p className="text-slate-600 mb-4 text-center">Contoh materi, tugas, atau aktivitas digital untuk Kelas 1 SD.</p>
                ...
                <div className="mt-16 flex flex-col items-center">
                    ...
                    <p className="text-slate-600 mb-4 text-center max-w-xl">Gabung gratis dan dapatkan akses ke semua fitur, template, dan materi terbaru untuk siswa Kelas 1 SD.</p>
